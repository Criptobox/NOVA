      ...
      <article className="card">
        ...
        <div className="panelbody">
          ...
          <div style={{ marginTop: 14, padding: '12px 14px', border: '1px solid var(--line)', borderRadius: 13, background: 'var(--soft)', fontSize: 11, lineHeight: 1.8 }}>
            ...
            &nbsp;&nbsp;• URL del callback: <code style={{ color: 'var(--code)' }}>{origin ? `${origin}/api/webhook/whatsapp` : '(este dominio)/api/webhook/whatsapp'}</code><br />
            &nbsp;&nbsp;• Verify token: <code style={{ color: 'var(--code)' }}>{st?.verifyToken || 'nova-verify'}</code><br />
